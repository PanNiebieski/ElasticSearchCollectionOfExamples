...
namespace ElasticsearchEnglishLanguage;

public class InsertedData
{
    private readonly ILogger<InsertedData> _logger;
    private readonly IElasticClient _elasticClient;

    public InsertedData(ILogger<InsertedData> logger, IElasticClient elasticClient)
    {
        _logger = logger;
